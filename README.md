...
[![Downloads](https://img.shields.io/github/downloads/ha-parcel-integrations/ha-delhivery/total.svg)](https://github.com/ha-parcel-integrations/ha-delhivery/releases)
...
Instead of polling Delhivery at the same rate around the clock, the
...
- **Fully stopped** — nothing is tracked, or every tracked parcel has been
  ...
  `delhivery.track_parcel` service, or a dashboard button) resumes polling
  immediately.
- A small, fixed per-hub offset is added on top, so not every Delhivery hub
...
This integration uses the same public tracking endpoint as the Delhivery consumer website. It is not affiliated with, endorsed by, or supported by Delhivery.
