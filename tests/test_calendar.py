"""Tests for the Delhivery deliveries calendar."""
from datetime import datetime, timezone
from unittest.mock import MagicMock

from custom_components.delhivery.calendar import DelhiveryDeliveriesCalendar
...
def _cal(data):
    return DelhiveryDeliveriesCalendar(_coordinator(data), _entry())
...
def test_pickup_sets_location():
    cal = _cal([_parcel("A", planned_from="2099-01-01T10:00:00Z", pickup=True, pickup_point="Delhivery Shop")])
    assert cal._events()[0].location == "Delhivery Shop"
